...
def main():
    ...
    print(f"Starting SECURITY analysis for review: {review_id} (SHA: {task_sha})")
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            if not changed_files:
                ...
                for file_path in changed_files:
                    ...
                    prompt = f"..." # Your Security Gemini prompt
        ...
        def update_error_atomically(transaction, review_ref, task_sha, error_message):
            ...
            if doc.get("pr_info.head_sha") == task_sha:
                transaction.update(review_ref, {"security_status": "error", "error_message": str(error_message)}) # <-- CHANGED
