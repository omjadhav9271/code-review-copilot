...
TARGET_JOB_NAME = os.environ.get("TARGET_JOB_NAME", "report-consolidator")  # <-- Updated for consolidator
...
async def handle_event(request: Request):
    ...
    the report-consolidator Cloud Run Job, passing the payload as an environment variable.
    """
    try:
